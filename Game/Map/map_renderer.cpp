/*********************************************************************
  \file    �}�b�v�`��V�X�e�� [map_renderer.cpp]
...
namespace Game {
 ...
 // �}�N����`
 //*****************************************************************************
#define CUBE_VERTEX_COUNT 24  // 1��4���_ �~ 6��
#define CUBE_INDEX_COUNT 36   // 6�� �~ 2�O�p�` �~ 3���_

//*****************************************************************************
// �����̂̒��_�f�[�^�iUnity����: 24���_�{36�C���f�b�N�X�j
//*****************************************************************************
...
// �C���f�b�N�X�o�b�t�@�i36�C���f�b�N�X: 6�ʁ~2�O�p�`�~3���_�j
